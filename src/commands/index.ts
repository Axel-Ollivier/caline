...
import { joinChannelCommand, leaveChannelCommand, closeDmCommand, toggleAutoJoinCommand } from './channels';
...
export function registerCommands(cm: ConnectionManager, chatPanel: ChatPanel): vscode.Disposable[] {
  return [
    ...
    vscode.commands.registerCommand('caline.closeDm', (item) => closeDmCommand(cm, item)),
